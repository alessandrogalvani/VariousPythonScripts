...
dati=pd.read_table('perbinderattorno35.txt',delim_whitespace=True, names=["L", "h" ,"m2","m4"]) #,header=None)
...
plt.plot(listah[0],lista[0],'c',listah[1],lista[1],'b',listah[2],lista[2],'m',listah[3],lista[3],'k' )
